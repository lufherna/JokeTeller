const tellAJokeButton = document.getElementById('button');
const audioElement    = document.getElementById('audio');
import { myModule } from './simpleKeys.js';
...
// toggle it between true or false by having the value
// set as the opposite of button disabled
function toggleButton() {
    tellAJokeButton.disabled = !tellAJokeButton.disabled;
}
...
async function getJokes() {
    ...
    try {
        ...
        // setup only happens with 2 part jokes
        if (data.setup) {
        ...
        // catch errors here
        console.log('Whoops, this is broken af', error)
    }
}

// event listeners
tellAJokeButton.addEventListener('click', getJokes);
